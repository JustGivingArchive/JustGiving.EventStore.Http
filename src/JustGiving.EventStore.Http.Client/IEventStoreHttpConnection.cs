...
namespace JustGiving.EventStore.Http.Client
{
    public interface IEventStoreHttpConnection
    {
        ...
        /// <param name="userCredentials">The optional user credentials to perform operation with.</param>
        /// <param name="events">The events to append to the stream</param>
        Task AppendToStreamAsync(string stream, int expectedVersion, UserCredentials userCredentials, params NewEventData[] events);
        ...
        /// <param name="events">The events to append to the stream</param>
        /// <param name="userCredentials">The optional user credentials to perform operation with.</param>
        Task AppendToStreamAsync(string stream, int expectedVersion, IEnumerable<NewEventData> events, UserCredentials userCredentials = null);
        ...
        Task<EventReadResult> ReadEventAsync(string stream, int eventNumber, UserCredentials userCredentials = null);
        ...
        Task<StreamEventsSlice> ReadStreamEventsForwardAsync(string stream, int start, int count, UserCredentials userCredentials = null);
    }
}